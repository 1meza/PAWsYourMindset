    ...
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-blue-900">
      ...
      <div className="cursor-default flex flex-col gap-3 rounded-md p-3">
        <Link className="relative inline-block text-4xl group" to="/Questions">
          <span className="relative z-10 block px-16 py-8 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-4 border-gray-900 rounded-lg group-hover:text-black">
